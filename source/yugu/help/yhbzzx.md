...
title: 浴谷用户帮助中心
updated: '2025-06-01T15:45:03.093+08:00'
---
# 账号
...
浴谷用户名后显示的 Tag 分为七种类型。分别为管理员 Tag（紫色）、退任管理员 Tag（红色）、浴谷商城付费 Tag（淡橙色）、文字 Tag（跟随用户名颜色）、月活名单第一位无 Tag 用户 Tag（淡蓝色）、洛谷账号同步 Tag（绿色），以及对应作弊者（棕色）的惩罚。
